...
public class Base64 {
    ...
    public byte[] encode(byte[] data, int lineLength, String lineSeparator) {
        ...
        return real.java.util.Base64.getMimeEncoder(lineLength, lineSeparator.getBytes()).encode(data);
    }
    ...
    public boolean encode(File src, File dst, int lineLength, String lineSeparator) {
        ...
        try {
            real.java.util.Base64.Encoder encoder = real.java.util.Base64.getMimeEncoder(lineLength, lineSeparator.getBytes());
    ...
    public byte[] decode(byte[] data, boolean hasLineSeparator) {
        if (!hasLineSeparator)
            return real.java.util.Base64.getDecoder().decode(data);
        else
            return real.java.util.Base64.getMimeDecoder().decode(data);
    }
    ...
    public boolean decode(File src, File dst, boolean hasLineSeparator) {
        try {
            real.java.util.Base64.Decoder decoder = hasLineSeparator ? real.java.util.Base64.getMimeDecoder() : real.java.util.Base64.getDecoder();
